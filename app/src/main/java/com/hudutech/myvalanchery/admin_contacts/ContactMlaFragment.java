...
import com.hudutech.myvalanchery.models.contact_models.Mla;
 ...
 */
public class ContactMlaFragment extends Fragment implements View.OnClickListener {
    private static final String TAG = "ContactMlaFragment";
    ...
    private CollectionReference mlaRef;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_contact_mla, container, false);
        ...
        mContext = getContext();
        mlaRef = FirebaseFirestore.getInstance().collection("mlas");
    ...
    private void submitData(
        ...
        try {
            ...
            String fileName = mlaRef.document().getId();
