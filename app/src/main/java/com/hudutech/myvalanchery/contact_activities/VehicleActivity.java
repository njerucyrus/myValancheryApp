...
import com.hudutech.myvalanchery.adapters.contact_adapter.VehicleSectionAdapter;
...
public class VehicleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VehicleSectionAdapter mSectionsPagerAdapter = new VehicleSectionAdapter(getSupportFragmentManager());
