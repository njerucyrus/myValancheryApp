...
import com.hudutech.myvalanchery.adapters.contact_adapter.ProfessionalListAdapter;
import com.hudutech.myvalanchery.models.contact_models.Professional;
 ...
 */
public class DocumentWritingFragment extends Fragment {
    private static final String TAG = "DocumentWritingFragment";
    ...
    public DocumentWritingFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_engineers, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("category", "Document Writing").get()
