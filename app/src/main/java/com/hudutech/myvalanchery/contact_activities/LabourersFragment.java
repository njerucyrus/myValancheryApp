 ...
 */
public class LabourersFragment extends Fragment {
    private static final String TAG = "LabourersFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_labourers, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("category", "Labourers").get()
