...
import com.hudutech.myvalanchery.adapters.contact_adapter.PoliticsListAdapter;
 ...
 */
public class SDPIFragment extends Fragment {
    private static final String TAG = "SDPIFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_sdpi, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("party", "SDPI").get()
