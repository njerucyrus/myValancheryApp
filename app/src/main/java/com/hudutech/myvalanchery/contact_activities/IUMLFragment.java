 ...
 */
public class IUMLFragment extends Fragment {
    private static final String TAG = "IUMLFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_iuml, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("party", "IUML").get()
