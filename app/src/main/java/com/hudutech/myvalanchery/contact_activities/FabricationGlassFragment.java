...
import com.hudutech.myvalanchery.adapters.contact_adapter.LabourerListAdapter;
 ...
 */
public class FabricationGlassFragment extends Fragment {
    private static final String TAG = "FabricationGlassFragmen";
    ...
    public FabricationGlassFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fabrication_glass, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("category", "Fabrication&Glass").get()
