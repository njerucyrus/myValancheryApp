 ...
 */
public class CPIMFragment extends Fragment {
    private static final String TAG = "CPIMFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_cpim, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("party", "CPIM").get()
