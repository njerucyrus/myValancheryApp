...
import com.hudutech.myvalanchery.adapters.contact_adapter.MediaListAdapter;
...
public class NewsPaperFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_news_paper, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("mediaType", "Newspaper").get()
