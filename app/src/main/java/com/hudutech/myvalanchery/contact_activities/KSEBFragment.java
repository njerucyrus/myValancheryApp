...
import com.hudutech.myvalanchery.adapters.contact_adapter.EmergencyListAdapter;
 ...
 */
public class KSEBFragment extends Fragment {
    private static final String TAG = "KSEBFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_kseb, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mVehicleRef.whereEqualTo("emergencyType", "KSEB").get()
