 ...
 */
public class CurtainSofaFragment extends Fragment {
    private static final String TAG = "CurtainSofaFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_curtain_sofa, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("category", "Curtain&Sofa").get()
