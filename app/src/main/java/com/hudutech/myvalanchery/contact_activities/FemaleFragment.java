...
import com.hudutech.myvalanchery.adapters.contact_adapter.PartnerListAdapter;
...
public class FemaleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContext = getContext();
        mRef = FirebaseFirestore.getInstance().collection("partners");
        partnerList = new ArrayList<>();
        mAdapter = new PartnerListAdapter(mContext, partnerList);
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("gender", "Female").get()
                    ...
                    public void onSuccess(QuerySnapshot documentSnapshots) {
                        ...
                        if (documentSnapshots.getDocuments().size() > 0) {
                            for (DocumentSnapshot snapshot : documentSnapshots.getDocuments()) {
                                Partner partner = snapshot.toObject(Partner.class);
                                if (partner != null) {
