 ...
 */
public class AutoVehicleFragment extends Fragment {
    private static final String TAG = "AutoVehicleFragment";
    ...
    private void loadVehicles() {
        ...
        mVehicleRef.whereEqualTo("vehicleType", "Auto").get()
