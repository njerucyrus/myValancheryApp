...
import com.hudutech.myvalanchery.adapters.contact_adapter.FindPartnerSectionAdapter;
...
public class FindPartnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FindPartnerSectionAdapter mSectionsPagerAdapter = new FindPartnerSectionAdapter(getSupportFragmentManager());
