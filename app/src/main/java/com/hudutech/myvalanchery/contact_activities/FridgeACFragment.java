 ...
 */
public class FridgeACFragment extends Fragment {
    private static final String TAG = "FridgeACFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fridge_ac, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("category", "Fridge&AC").get()
