package com.hudutech.myvalanchery.admin_medical;
...
import com.hudutech.myvalanchery.models.medical_models.Optical;
 ...
 */
public class OpticalFragment extends Fragment implements View.OnClickListener {
    private static final String TAG = "OpticalFragment";
    ...
    private CollectionReference mOpticalRef;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mOpticalRef = FirebaseFirestore.getInstance().collection("opticals");
    ...
    private void submitData(
        ...
        try {
            ...
            String fileName = mOpticalRef.document().getId();
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    DocumentReference docRef = mOpticalRef.document();
