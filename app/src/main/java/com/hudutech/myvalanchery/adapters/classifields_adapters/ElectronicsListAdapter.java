...
import com.hudutech.myvalanchery.classifields_activities.ElectronicsDetailActivity;
...
public class ElectronicsListAdapter extends RecyclerView.Adapter<ElectronicsListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mContext.startActivity(new Intent(mContext, ElectronicsDetailActivity.class)
                        .putExtra("electronic", electronic)
                );
            }
        });
