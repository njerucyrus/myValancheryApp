...
import com.hudutech.myvalanchery.models.majery_models.Education;

public class EducationDetailActivity extends AppCompatActivity {

    private static final String TAG = "EducationDetailActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        education = (Education) getIntent().getSerializableExtra("education");
        getSupportActionBar().setTitle(education.getPlaceName());
        ...
        mButtonDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(EducationDetailActivity.this);
        ...
        mButtonInValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        updateIsValidated(education, false);
        ...
        mButtonValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        updateIsValidated(education, true);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_share) {
            String message = "Place Name " + education.getPlaceName() + "More Info " + education.getDescription();
            Config.share(EducationDetailActivity.this, "Tourism Place", message);
        }

        return super.onOptionsItemSelected(item);
    }

    private void delete(final Education education) {
        /*
        ...
        CollectionReference ref = FirebaseFirestore.getInstance().collection("education");
        ref.document(education.getDocKey())
                .delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(EducationDetailActivity.this, " record deleted", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        if (mProgress.isShowing()) mProgress.dismiss();
                        Toast.makeText(EducationDetailActivity.this, "Failed to delete", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void updateIsValidated(final Education education, boolean isValidated) {
        mProgress.setMessage("Updating please wait...");
        mProgress.setCanceledOnTouchOutside(false);
        mProgress.show();
        final FirebaseFirestore db = FirebaseFirestore.getInstance();
        db.collection("education")
                .document(education.getDocKey())
                .update("validated", isValidated)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {

                        Toast.makeText(EducationDetailActivity.this, "Updated successfully", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EducationDetailActivity.this, EducationActivity.class)
                                .putExtra("menuName", "Education")
                        );
                        finish();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        if (mProgress.isShowing()) mProgress.dismiss();
                        Toast.makeText(EducationDetailActivity.this, "Error occurred! Update failed.", Toast.LENGTH_SHORT).show();
                    }
                });
