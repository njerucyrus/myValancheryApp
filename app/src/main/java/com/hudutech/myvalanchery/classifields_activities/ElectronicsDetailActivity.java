...
import com.hudutech.myvalanchery.models.classifields_models.Electronic;
...
public class ElectronicsDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(electronic.getHeading());
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        TextView hotelName = findViewById(R.id.tv_name);
        hotelName.setText(electronic.getHeading());

        TextView price = findViewById(R.id.tv_price);
        price.setText("INR " + electronic.getAmount());


        TextView address = findViewById(R.id.tv_location);
        address.setText(electronic.getLocation());


        TextView details = findViewById(R.id.tv_desc);
        details.setText(electronic.getHeading() + " " + electronic.getBrand() + ", " + electronic.getDescription());

        TextView brand = findViewById(R.id.tv_brand);
        brand.setText(electronic.getBrand());

        TextView model = findViewById(R.id.tv_model);
        model.setText(electronic.getModel());

        TextView year = findViewById(R.id.tv_year);
        year.setText(String.valueOf(electronic.getYear()));


        List<Banner> bannerList = new ArrayList<>();
        for (String imageUrl : electronic.getPhotoUrls()) {
        ...
        tvCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Config.call(ElectronicsDetailActivity.this, electronic.getPhoneNumber());
            }
        });
