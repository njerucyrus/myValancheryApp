...
public class RestaurantDetailActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_share) {
            String message = "Name " + restaurant.getName() + " Address " + restaurant.getAddress() + ", " + restaurant.getPlaceName();
            Config.share(RestaurantDetailActivity.this, "Restaurant", message);
        }
