...
import com.hudutech.myvalanchery.adapters.digital_adapters.TransactionAdapter;
...
public class DepositsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView mRecyclerView = view.findViewById(R.id.deposits_recyclerview);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mRecyclerView.setAdapter(mAdapter);
        mRecyclerView.setHasFixedSize(true);

        tvNoData = view.findViewById(R.id.tv_no_deposits);
