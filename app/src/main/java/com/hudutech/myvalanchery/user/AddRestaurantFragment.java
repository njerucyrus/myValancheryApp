...
public class AddRestaurantFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPhoneNumber = v.findViewById(R.id.txt_restaurant_phone_number);
        mMoreDetails = v.findViewById(R.id.txt_restaurant_more_details);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_choose_restaurant_images) {
            openImageChooser();
        } else if (id == R.id.btn_select_restaurant_location) {
            showPlacePicker();
        } else if (id == R.id.btn_submit_restaurant) {
            if (validateInputs()) {
                submitData(imageUris, mRestaurantName.getText().toString(), mPlaceName.getText().toString(), lat, lng, address, mPhoneNumber.getText().toString(), mMoreDetails.getText().toString());
            } else {
                ...
                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        if (imageDownloadUrls.size() == imageUris.length) {
                            ...
                            DocumentReference docRef = mRestaurantRef.document();
    ...
    private boolean validateInputs() {
        ...
        if (TextUtils.isEmpty(mRestaurantName.getText().toString().trim())) {
            valid = false;
            mRestaurantName.setError("*Required!");
        } else {
