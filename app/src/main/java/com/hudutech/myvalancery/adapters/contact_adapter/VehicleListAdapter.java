...
public class VehicleListAdapter extends RecyclerView.Adapter<VehicleListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.mShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String desc = "Place " + vehicle.getPlace() + " Contact " + vehicle.getPhoneNumber()+linkMessage;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void deleteVehicle(final Vehicle vehicle, final int position) {
            ...
            CollectionReference ref = db.collection("contact_vehicles");
        ...
        public void updateIsValidated(final Vehicle vehicle, boolean isValidated, final int position) {
            ...
            mProgress.setCanceledOnTouchOutside(false);
            mProgress.show();
            db.collection("contact_vehicles")
