package com.hudutech.myvalancery.adapters.medical_adapters;
...
import com.hudutech.myvalancery.MapsActivity;
import com.hudutech.myvalancery.R;
import com.hudutech.myvalancery.models.medical_models.Lab;
...
public class LabListAdapter extends RecyclerView.Adapter<LabListAdapter.ViewHolder> {
    ...
    public LabListAdapter(Context mContext, List<Lab> labList) {
    ...
    public LabListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new LabListAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        final Lab lab = labList.get(position);
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        holder.delete(lab, holder.getAdapterPosition());
        ...
        holder.mButtonValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        holder.updateIsValidated(lab, true, holder.getAdapterPosition());
        ...
        holder.mButtonInValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        holder.updateIsValidated(lab, false, holder.getAdapterPosition());
        ...
        holder.mName.setText(lab.getLabName());
        holder.mPhoneNumber.setText(lab.getContactNo());
        holder.mLocation.setText(lab.getPlace());

        RequestOptions requestOptions = new RequestOptions()
                .placeholder(R.drawable.no_barner);

        Glide.with(mContext)
                .load(lab.getPhotoUrl())
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void delete(final Lab lab, final int position) {
            /*
        ...
        public void updateIsValidated(final Lab lab, boolean isValidated, final int position) {
                            ...
                            db.collection("labs")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                        ...
                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                            if (mProgress.isShowing()) mProgress.dismiss();
                                            Lab newItem = documentSnapshot.toObject(Lab.class);
                                            labList.set(position, newItem);
