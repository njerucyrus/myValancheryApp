package com.hudutech.myvalancery.adapters.timming_adapters;
...
import com.hudutech.myvalancery.timing_and_booking_activities.RestaurantDetailActivity;
...
public class RestaurantListAdapter extends RecyclerView.Adapter<RestaurantListAdapter.ViewHolder> {
    ...
    public RestaurantListAdapter(Context mContext, List<Restaurant> restaurantList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        holder.delete(restaurant, holder.getAdapterPosition());
        ...
        holder.mButtonValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        holder.updateIsValidated(restaurant, true, holder.getAdapterPosition());
        ...
        holder.mButtonInValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        holder.updateIsValidated(restaurant, false, holder.getAdapterPosition());
        ...
        Glide.with(mContext)
                .load(restaurant.getPhotoUrls().get(0))
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void delete(final Restaurant restaurant, final int position) {
            /*
            ...
            CollectionReference ref = db.collection("restaurants");
            ref.document(restaurant.getDocKey())
                    .delete()
                            ...
                            db.collection("restaurants")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                        ...
                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                            if (mProgress.isShowing()) mProgress.dismiss();
                                            Restaurant newItem = documentSnapshot.toObject(Restaurant.class);
                                            restaurantList.set(position, newItem);
