...
public class EmergencyListAdapter extends RecyclerView.Adapter<EmergencyListAdapter.ViewHolder> {
    ...
    public EmergencyListAdapter(Context mContext, List<Emergency> emergencyList) {
    ...
    @NonNull
    @Override
    public EmergencyListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_contact_vehicle_item, parent, false);
        return new EmergencyListAdapter.ViewHolder(v);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        holder.delete(emergency, holder.getAdapterPosition());
        ...
        holder.mButtonValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        holder.updateIsValidated(emergency, true, holder.getAdapterPosition());
        ...
        holder.mButtonInValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        holder.updateIsValidated(emergency, false, holder.getAdapterPosition());
        ...
        holder.mName.setText(emergency.getName());
        holder.mPhoneNumber.setText(emergency.getPhoneNumber());
        holder.mLocation.setText(emergency.getPlace());

        RequestOptions requestOptions = new RequestOptions()
                .placeholder(R.drawable.no_barner);

        Glide.with(mContext)
                .load(emergency.getPhotoUrl())
        ...
        holder.mShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String desc = "Place " + emergency.getPlace() + " Contact " + emergency.getPhoneNumber()+linkMessage;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void delete(final Emergency emergency, final int position) {
            /*
                            ...
                            db.collection("emergency")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                        ...
                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                            if (mProgress.isShowing()) mProgress.dismiss();
                                            Emergency newItem = documentSnapshot.toObject(Emergency.class);
                                            emergencyList.set(position, newItem);
