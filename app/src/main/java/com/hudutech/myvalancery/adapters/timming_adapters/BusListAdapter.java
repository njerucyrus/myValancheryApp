...
public class BusListAdapter extends RecyclerView.Adapter<BusListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.mArrival.setText( bus.getArrivalTime());
        holder.mDeparture.setText(bus.getDepartureTime());
        holder.mWay.setText("Way: " + bus.getWay());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            mWay = itemView.findViewById(R.id.tv_way);
