...
import com.hudutech.myvalancery.majery_activities.ShopDetailActivity;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.mShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String desc = "Place " + shop.getShopLocation() + "Type" + shop.getShopType() + " Contact " + shop.getShopContact()+linkMessage;
