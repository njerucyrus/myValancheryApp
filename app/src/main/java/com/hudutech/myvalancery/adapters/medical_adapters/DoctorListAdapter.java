...
import com.hudutech.myvalancery.models.medical_models.Doctor;
...
public class DoctorListAdapter extends RecyclerView.Adapter<DoctorListAdapter.ViewHolder> {
    ...
    public DoctorListAdapter(Context mContext, List<Doctor> doctorList) {
    ...
    public DoctorListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DoctorListAdapter.ViewHolder(v);
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        holder.delete(doctor, holder.getAdapterPosition());
        ...
        holder.mButtonValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        holder.updateIsValidated(doctor, true, holder.getAdapterPosition());
        ...
        holder.mButtonInValidate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        holder.updateIsValidated(doctor, false, holder.getAdapterPosition());
        ...
        holder.mName.setText(doctor.getDoctorName());
        holder.mPhoneNumber.setText(doctor.getPhoneNumber());
        holder.mLocation.setText(doctor.getDepartment());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void delete(final Doctor doctor, final int position) {
            /*
        ...
        public void updateIsValidated(final Doctor doctor, boolean isValidated, final int position) {
            mProgress.setMessage("Updating please wait...");
            mProgress.setCanceledOnTouchOutside(false);
            mProgress.show();
            db.collection("doctors")
                    .document(doctor.getDocKey())
