...
import com.hudutech.myvalancery.models.Travel;
...
public class TravelFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mImageViewPager = v.findViewById(R.id.viewPager);
        tvSelectedImgs = v.findViewById(R.id.tv_selected_imgs);

        mName = v.findViewById(R.id.txt_name);
        mPlaceName = v.findViewById(R.id.txt_place);

        mPhoneNumber = v.findViewById(R.id.txt_phone_number);
        mMoreDetails = v.findViewById(R.id.txt_more_details);
        ...
        mRef = FirebaseFirestore.getInstance().collection("travel");
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_upload_photos) {
            openImageChooser();
        } else if (id == R.id.btn_pick_location) {
            showPlacePicker();
        } else if (id == R.id.btn_submit) {
            if (validateInputs()) {
                submitData(imageUris, mName.getText().toString(), mPlaceName.getText().toString(), lat, lng, address, mPhoneNumber.getText().toString(), mMoreDetails.getText().toString());
            } else {
