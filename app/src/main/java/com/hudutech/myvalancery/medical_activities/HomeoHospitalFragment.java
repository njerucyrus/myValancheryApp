 ...
 */
public class HomeoHospitalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_homeo_hospital, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mProgress.show();
        mRef.whereEqualTo("category", "Homeo")
                .get()
