 ...
 */
public class AyourvedicHospitalFragment extends Fragment {
    ...
    public AyourvedicHospitalFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ayourvedic_hospital, container, false);
        mContext = getContext();
