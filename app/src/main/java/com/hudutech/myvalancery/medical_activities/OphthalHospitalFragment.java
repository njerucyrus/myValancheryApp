...
import com.hudutech.myvalancery.adapters.medical_adapters.HospitalListAdapter;
import com.hudutech.myvalancery.models.medical_models.Hospital;
 ...
 */
public class OphthalHospitalFragment extends Fragment {
    ...
    public OphthalHospitalFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ophthal_hospital, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mProgress.show();
        mRef.whereEqualTo("category", "Ophthal")
                .get()
