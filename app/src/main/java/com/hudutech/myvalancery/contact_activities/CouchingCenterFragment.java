...
import com.hudutech.myvalancery.adapters.contact_adapter.InstitutionListAdapter;
import com.hudutech.myvalancery.models.contact_models.Institution;
 ...
 */
public class CouchingCenterFragment extends Fragment {
    private static final String TAG = "CouchingCenterFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_couching_center, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("category", "Coaching Centre").get()
