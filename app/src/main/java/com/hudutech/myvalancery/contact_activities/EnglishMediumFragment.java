 ...
 */
public class EnglishMediumFragment extends Fragment {
    private static final String TAG = "EnglishMediumFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_english_medium, container, false);
        mContext = getContext();
    ...
    private void loadData() {
        ...
        mRef.whereEqualTo("category", "English Medium").get()
